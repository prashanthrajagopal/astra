...
// ListActiveByOrg returns all active workers (single-platform: org_id removed; ignores orgID).
func (r *Registry) ListActiveByOrg(ctx context.Context, _ string) ([]WorkerInfo, error) {
